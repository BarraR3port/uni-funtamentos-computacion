...
public class TimeLogger {
    ...
    private static final String LOG_FILE = LOG_DIR + File.separator + "tiempos_ejecucion.txt";
    ...
    public static void logExecutionTime(int matrixSize, double seqTime, double parTime, int numThreads) {
        try (FileWriter writer = new FileWriter(LOG_FILE, true)) {
            ...
            if (new File(LOG_FILE).length() == 0) {
                ...
                sb.append("Fecha de inicio: ").append(LocalDateTime.now().format(formatter)).append("\n");
